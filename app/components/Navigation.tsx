...
const Navigation: React.FC = () => {
 ...
 const handleRocketClick = () => {
   // Toggle the menu state, flame state will follow via useEffect
   setIsOpen(!isOpen);
 };
   ...
   <nav className="fixed top-0 left-0 right-0 z-40 space-nav">
     ...
     <div className="md:hidden p-4">
       <button 
         ...
         className="text-[var(--starry-white)] relative"
       ...
       >
         ...
         >
           ...
           <motion.circle 
             ...
             cy="14" 
             r="1" 
             fill={isOpen ? "var(--space-black)" : "var(--starry-white)"} 
             animate={{ 
               fill: isOpen ? "var(--space-black)" : "var(--starry-white)",
               opacity: isIgnited ? 0.9 : 1
             }}
           />
