...
import { SiGooglecloud, SiPandas, SiNumpy, SiFlask, SiNodedotjs, SiNextdotjs, SiTailwindcss, SiPostgresql, SiMongodb, SiDocker, SiKubernetes, SiTensorflow, SiPrisma, SiCelery, SiGrafana } from 'react-icons/si';
...
const SkillsRingDesktop: React.FC = () => {
...
export default SkillsRingDesktop;
