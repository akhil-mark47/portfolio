...
const EducationRoadmapDesktop: React.FC = () => {
  ...
  return (
    <div className="relative min-h-[1000px] py-12 overflow-hidden" ref={containerRef}>
      ...
      <div className="absolute inset-0 z-0">
        ...
        >
          <source src="/assets/videos/public_videos_blackhole.webm" type="video/webm" />
      ...
      <div className="relative z-10">
        ...
        >
          <div className="w-1/2 pr-32 flex justify-end">
            <div className="relative gradient-border p-8 w-[28rem] rounded-full bg-[rgba(5,5,5,0.9)] hover:scale-110 transition-all hover:shadow-[0_0_30px_rgba(147,51,234,0.7)] z-10">
              ...
              <p className="font-[JetBrains Mono] text-gray-300">St. Mary's Bethany Convent Vidyalaya High School | 2021</p>
        ...
        {[...Array(5)].map((_, i) => (
          <motion.div
            ...
            style={{
              left: `calc(50% + ${Math.sin(i) * 30 - 15}px)`,
              top: `${i * 15 + 10}%`,
...
export default EducationRoadmapDesktop;
